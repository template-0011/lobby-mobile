...
<template>
  <svg :width="size" :height="size" fill="currentColor" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 22 22" aria-hidden="true" role="img" class="icon icon-navigation-casino sm square Tabs__link-icon Tabs__link-icon">
