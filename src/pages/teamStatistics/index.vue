...
<template>
  <Container :title="$t('web.i18nFront.label.teamSta')">
          ...
          >
            ...
            <div class="pb-4 text-sm">
              <div class="flex-center">
                {{ `${$t("web.i18nFront.label.teamBalance")}(${unit})` }}
              </div>
              <div class="flex-center pt-2 text-16px color-[var(--primary-color)]">
                {{ formatNum(teamOverall.totalMoney) }}
              </div>
            </div>
            <van-row class="text-sm">
              <van-col class="van-hairline--right text-center" :span="8">
                <div class="text-sm">
                  <div class="flex-center">
                    {{ $t("web.i18nFront.label.teamPeople") }}
                  </div>
                  <div class="flex-center pt-2 text-16px color-[var(--primary-color)]">
                    {{ teamOverall.totalUserCount }}
                  </div>
                </div>
              </van-col>
              <van-col class="van-hairline--right text-center" :span="8">
